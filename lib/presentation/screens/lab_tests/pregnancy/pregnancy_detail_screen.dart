...
class PregnancyDetailScreen extends StatelessWidget {
  final PregnancyLabTest test;

  const PregnancyDetailScreen({Key? key, required this.test}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pregnancy Test Details'),
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Expanded(child: Text('Pregnancy Test', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
                Container(
